...
\item Neural networks: $h(\boldsymbol{a}, \xx) = \xx_m^T \sigma(\xx_{m-1})$
\end{itemize}
...
\matrix[net] (mat)
{
|[plain]| \parbox{1.3cm}{\centering Input\\layer} \& |[plain]| \parbox{1.0cm}{\centering Hidden\\layer} \& |[plain]| \parbox{1.3cm}{\centering Output\\layer} \\
\& |[plain]| \\
|[plain]| \& \\
\& |[plain]| \\
  |[plain]| \& |[plain]| \\
