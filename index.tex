...
\begin{frame}{Outline}
\vspace{2em}\begin{columns}[T] % align columns
...
\begin{flushright}{\footnotesize images source: Francis Bach}\end{flushright}
\end{column}
\end{columns}
\end{frame}
...
\begin{frame}{XX}
This can also be extended to minibatch gradient descent.

Instead of choosing one sample, choose a subset of $k$ samples, and compute their gradient in parallel.

This is the parallelization implemented in most software: Hadoop, Tensorflow, PyTorch, etc.
\end{frame}
